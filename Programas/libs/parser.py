    ...
    while True:
        ...
        if a and a.group() == '&.[DSA].Normal.&':
            ...
            while True:
                ...
                c.pop(0) #!++..++!        
            block.pop() # pop last []
            _dict['\x04\x12'].append(block)
        if a and a.group() == '&.[MSS].Nome.&':
            block = []
            for x in range(6):
                buffer = array.array('c')
                while True:
