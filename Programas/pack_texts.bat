...
pypy inserter.py -m ".p2" -s "../Arquivos Traduzidos/UI/thr" -d "../ROM Modificada/xpa-khe/data/UI/thr" -fnt
...
pypy inserter.py -m ".p2" -s "../Arquivos Traduzidos/ev" -d "../ROM Modificada/xpa-khe/data/ev"
